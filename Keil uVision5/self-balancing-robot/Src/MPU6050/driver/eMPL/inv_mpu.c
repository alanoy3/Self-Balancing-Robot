...
#define delay_ms    HAL_Delay		//使用	STM32 HAL 庫   的  HAL_Delay   (單位 ms)
#define get_ms      HAL_GetTick  //使用	STM32 HAL 庫   的  HAL_GetTick   (單位 ms)
#define log_i       printf
#define log_e       printf
...
__weak int Sensors_I2C_WriteRegister(uint8_t addr, uint8_t reg, uint8_t len, uint8_t * data)
{
...
__weak int Sensors_I2C_ReadRegister(uint8_t addr, uint8_t reg, uint8_t len, uint8_t *data)
{
