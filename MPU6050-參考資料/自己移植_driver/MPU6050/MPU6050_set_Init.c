...
#define DEFAULT_MPU_HZ  (100)									//設定MPU6050採樣率 單位hz
#define lpf 						188										//低通濾波 ，The following LPF settings are supported: 188, 98, 42, 20, 10, 5.
#define set_gyro_fsr 		2000									//設定陀螺儀量測每秒最大度數 (2000 , 1000 , 500 , 250)
#define set_accel_fsr 		4										//設定加速計量測最大重力值 (2, 4 , 8 , 16)
